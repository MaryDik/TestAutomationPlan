### Тест-план по тестированию и автоматизации формы записи на обучение профессии «Тестировщик ПО»:
...
Шаг 1: Ввести валидные данные в поля «Имя», «Телефон», «Электронная почта»

Шаг 2: Нажать на  кнопку «Записаться» 

*__Ожидаемый результат:__* Появляется сообщение о том, что регистрация прошла успешно,  на указанный email приходит письмо «Заявка на курс «Тестировщик ПО» оформлена» 
...
Шаг 2: Ввести валидные данные в поля «Телефон» и «Электронная почта»

Шаг 3: Нажать на кнопку «Записаться»
...
Шаг 1: Ввести валидные данные в поля «Имя» и «Электронная почта» 
...
Шаг 1: Ввести валидные данные в поля «Имя», «Телефон»

Шаг 2: Оставить поле «Электронная почта» незаполненным 
...
Шаг 1: Ввести данные в поле на кириллице в диапазоне от 2 до 64 символов
...
Шаг 1: Ввести данные в поле на кириллице + цифры
...
*__Ожидаемый результат:__*  Отображается ошибка  *"Значение поля не может быть длиннее 64 символов"*

**Тест-кейс 9 Ввод валидных значений в поле "Телефон"**

Шаг 1: Ввести в поле 10 цифр от 0 до 9 цифры, код +7 (на первом месте)
...
Шаг 1: Ввести в поле 9 цифр от 0 до 9
...
**5.	Перечень необходимых специалистов для автоматизации:** *1 AQA инженер(Java)* 
